...
#include "c2_DYNctl_ver4_etud_nonlineaire.h"
...
static const char * c2_debug_family_names[4] = { "nargin", "nargout", "angle",
  "f" };

/* Function Declarations */
static void initialize_c2_DYNctl_ver4_etud_nonlineaire
  (SFc2_DYNctl_ver4_etud_nonlineaireInstanceStruct *chartInstance);
static void initialize_params_c2_DYNctl_ver4_etud_nonlineaire
  (SFc2_DYNctl_ver4_etud_nonlineaireInstanceStruct *chartInstance);
static void enable_c2_DYNctl_ver4_etud_nonlineaire
  (SFc2_DYNctl_ver4_etud_nonlineaireInstanceStruct *chartInstance);
static void disable_c2_DYNctl_ver4_etud_nonlineaire
  (SFc2_DYNctl_ver4_etud_nonlineaireInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_DYNctl_ver4_etud_nonlineaire
  (SFc2_DYNctl_ver4_etud_nonlineaireInstanceStruct *chartInstance);
...
static void set_sim_state_c2_DYNctl_ver4_etud_nonlineaire
   ...
   *c2_st);
static void finalize_c2_DYNctl_ver4_etud_nonlineaire
  (SFc2_DYNctl_ver4_etud_nonlineaireInstanceStruct *chartInstance);
static void sf_gateway_c2_DYNctl_ver4_etud_nonlineaire
  (SFc2_DYNctl_ver4_etud_nonlineaireInstanceStruct *chartInstance);
static void mdl_start_c2_DYNctl_ver4_etud_nonlineaire
  (SFc2_DYNctl_ver4_etud_nonlineaireInstanceStruct *chartInstance);
static void initSimStructsc2_DYNctl_ver4_etud_nonlineaire
  (SFc2_DYNctl_ver4_etud_nonlineaireInstanceStruct *chartInstance);
...
static uint8_T c2_d_emlrt_marshallIn
  (SFc2_DYNctl_ver4_etud_nonlineaireInstanceStruct *chartInstance, const mxArray
   *c2_b_is_active_c2_DYNctl_ver4_etud_nonlineaire, const char_T *c2_identifier);
  ...
  (SFc2_DYNctl_ver4_etud_nonlineaireInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_DYNctl_ver4_etud_nonlineaire = 0U;
}
   ...
   *c2_b_is_active_c2_DYNctl_ver4_etud_nonlineaire, const char_T *c2_identifier)
{
  ...
  c2_y = c2_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_DYNctl_ver4_etud_nonlineaire), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_DYNctl_ver4_etud_nonlineaire);
  return c2_y;
}
...
static void init_simulink_io_address
  (SFc2_DYNctl_ver4_etud_nonlineaireInstanceStruct *chartInstance)
{
  chartInstance->c2_angle = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c2_f = (real_T *)ssGetOutputPortSignal_wrapper(chartInstance->S,
    1);
}
...
void sf_c2_DYNctl_ver4_etud_nonlineaire_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c2_DYNctl_ver4_etud_nonlineaire_get_post_codegen_info(void);
...
mxArray *sf_c2_DYNctl_ver4_etud_nonlineaire_jit_fallback_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_DYNctl_ver4_etud_nonlineaire(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"f\",},{M[8],M[0],T\"is_active_c2_DYNctl_ver4_etud_nonlineaire\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_DYNctl_ver4_etud_nonlineaire_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c2_DYNctl_ver4_etud_nonlineaire(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_DYNctl_ver4_etud_nonlineaireInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_DYNctl_ver4_etud_nonlineaire
    ((SFc2_DYNctl_ver4_etud_nonlineaireInstanceStruct*) chartInstanceVar);
  initialize_c2_DYNctl_ver4_etud_nonlineaire
    ((SFc2_DYNctl_ver4_etud_nonlineaireInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_DYNctl_ver4_etud_nonlineaire(void
  *chartInstanceVar)
{
  enable_c2_DYNctl_ver4_etud_nonlineaire
    ((SFc2_DYNctl_ver4_etud_nonlineaireInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_DYNctl_ver4_etud_nonlineaire(void
  *chartInstanceVar)
{
  disable_c2_DYNctl_ver4_etud_nonlineaire
    ((SFc2_DYNctl_ver4_etud_nonlineaireInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_DYNctl_ver4_etud_nonlineaire(void
  *chartInstanceVar)
{
  sf_gateway_c2_DYNctl_ver4_etud_nonlineaire
    ((SFc2_DYNctl_ver4_etud_nonlineaireInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_DYNctl_ver4_etud_nonlineaire
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c2_DYNctl_ver4_etud_nonlineaire
    ((SFc2_DYNctl_ver4_etud_nonlineaireInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_DYNctl_ver4_etud_nonlineaire(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c2_DYNctl_ver4_etud_nonlineaire
    ((SFc2_DYNctl_ver4_etud_nonlineaireInstanceStruct*)chartInfo->chartInstance,
     st);
}

static void sf_opaque_terminate_c2_DYNctl_ver4_etud_nonlineaire(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_DYNctl_ver4_etud_nonlineaireInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_DYNctl_ver4_etud_nonlineaire
      ((SFc2_DYNctl_ver4_etud_nonlineaireInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_DYNctl_ver4_etud_nonlineaire
    ((SFc2_DYNctl_ver4_etud_nonlineaireInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_DYNctl_ver4_etud_nonlineaire(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_DYNctl_ver4_etud_nonlineaire(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c2_DYNctl_ver4_etud_nonlineaire(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
void c2_DYNctl_ver4_etud_nonlineaire_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_DYNctl_ver4_etud_nonlineaire(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_DYNctl_ver4_etud_nonlineaire(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_DYNctl_ver4_etud_nonlineaire(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_DYNctl_ver4_etud_nonlineaire_method_dispatcher.\n"
